    ...
    <div class="container">
        <div class="row">
            <table class="table">
                ...
                $datos = $obj->mostrarConductor($sql);
                ...
                ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="../../views/conductor/editConductor.php?id=<?php echo $key['id'] ?>" class="btn btn-secondary btn-sm">
                                    <i class="fas fa-marker"></i> Actualizar
                                </a>

                                <a href="../../procesos/conductor/deleteConductor.php?id=<?php echo $key['id'] ?>" class="btn btn-danger btn-sm">
